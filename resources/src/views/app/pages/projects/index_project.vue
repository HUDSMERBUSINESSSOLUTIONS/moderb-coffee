<template>
  <div class="main-content">
    <breadcumb :page="$t('Delivery_List')" :folder="$t('Delivery')"/>
        ...
        <template slot="table-row" slot-scope="props">
          <span v-if="props.column.field == 'actions'">
            <div>
              ...
              >
                ...
                <b-navbar-nav>
                  <b-dropdown-item title="Show" :to="'/app/projects/detail/'+props.row.id">
                ...
                <b-dropdown-item
                  ...
                  :to="'/app/projects/sale_return/'+props.row.id"
                >
          ...
          <div v-else-if="props.column.field == 'shipping_status'">
           ...
           <div v-else-if="props.column.field == 'Ref'">
              <router-link
                :to="'/app/projects/detail/'+props.row.id"
              >
