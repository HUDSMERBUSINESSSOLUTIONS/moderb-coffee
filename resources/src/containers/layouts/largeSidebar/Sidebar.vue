        ...
        <ul class="navigation-left">
          ...
          >
            <a class="nav-item-hold" href="#">
              ...
              <span class="nav-text">{{$t('Delivery')}}</span>
            </a>
            <div class="triangle"></div>
          </li>
    ...
    >
      ...
      <!-- hrm -->
        ...
        >
          ...
          >
            <router-link tag="a" class to="/app/Projects/Payments">
              <i class="nav-icon i-Administrator"></i>
        ...
        >
          ...
          >
            ...
            <router-link tag="a" class to="/app/People/ongoing">
              <i class="nav-icon i-Administrator"></i>
              <span class="item-name">{{$t('Delivery person')}}</span>
            </router-link>
          </li>
        </ul>
      <!-- Delivery -->
